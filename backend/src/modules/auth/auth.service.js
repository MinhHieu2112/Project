    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (registerDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, firstName, lastName, existingUser, hashedPassword, user, tokens, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 7, , 8]);
                            return [4 /*yield*/, bcrypt.hash(password, this.SALT_ROUNDS)];
                        case 3:
        ...
        AuthService_1.prototype.generateTokens = function (userId, email) {
            return __awaiter(this, void 0, void 0, function () {
                var payload, refreshId, _a, accessToken, refreshToken;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            payload = { sub: userId, email: email };
                            refreshId = (0, crypto_1.randomBytes)(16).toString('hex');
                            return [4 /*yield*/, Promise.all([
                                    this.jwtService.signAsync(payload, { expiresIn: '15m' }),
                                    this.jwtService.signAsync(__assign(__assign({}, payload), { refreshId: refreshId }), { expiresIn: '7d' }),
                                ])];
                        case 1:
        ...
        AuthService_1.prototype.updateRefreshToken = function (userId, refreshToken) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AuthService_1.prototype.refreshTokens = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var user, tokens;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, user, _a, tokens;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 4:
                            tokens = _b.sent();
                            return [4 /*yield*/, this.updateRefreshToken(user.id, user.email)];
                        case 5:
                            _b.sent();
